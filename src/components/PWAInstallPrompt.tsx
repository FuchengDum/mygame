...
export default function PWAInstallPrompt() {
  ...
  return (
    <div className="fixed bottom-0 left-4 right-4 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-lg p-4 pb-safe shadow-lg z-50 animate-slide-up" role="alert" aria-live="polite" aria-label="安装游戏提示">
